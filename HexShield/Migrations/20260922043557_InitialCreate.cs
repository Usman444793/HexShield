        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationNodes_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrganizationNodeId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserOrganizationRoles_OrganizationNodes_OrganizationNodeId",
                        column: x => x.OrganizationNodeId,
                        principalTable: "OrganizationNodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryTeacherProfileId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_OrganizationNodes_OrganizationNodeId",
                        column: x => x.OrganizationNodeId,
                        principalTable: "OrganizationNodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Courses_TeacherProfiles_PrimaryTeacherProfileId",
                        column: x => x.PrimaryTeacherProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonProgresses_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAnswerOptions", x => new { x.QuizAnswerId, x.QuestionOptionId });
                    table.ForeignKey(
                        name: "FK_QuizAnswerOptions_QuestionOptions_QuestionOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_OrganizationNodeId",
                table: "Courses",
                column: "OrganizationNodeId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_PrimaryTeacherProfileId",
                table: "Courses",
                column: "PrimaryTeacherProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_TenantId_CourseCode",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgresses_StudentProfileId_LessonId",
                table: "LessonProgresses",
                columns: new[] { "StudentProfileId", "LessonId" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationNodes_HierarchyPath",
                table: "OrganizationNodes",
                column: "HierarchyPath");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationNodes_ParentId",
                table: "OrganizationNodes",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationNodes_TenantId_Code",
                table: "OrganizationNodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswerOptions_QuestionOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrganizationRoles_OrganizationNodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrganizationRoles_UserId_RoleId_OrganizationNodeId",
                table: "UserOrganizationRoles",
                columns: new[] { "UserId", "RoleId", "OrganizationNodeId" },
                unique: true,
                filter: "[IsDeleted] = 0");
        }
